...
# Page Recherche par film
    ...
    if movie_search == "Tout":
        ...
        # Appliquer le tri aux résultats de recherche
        if sort_option == "Année de sortie (croissant)":
        ...
        # Appliquer le tri aux suggestions KNN
        if sort_option == "Année de sortie (croissant)":
            knn_results = knn_results.sort_values(by='Year', ascending=True)
        elif sort_option == "Année de sortie (décroissant)":
            knn_results = knn_results.sort_values(by='Year', ascending=False)
        elif sort_option == "Note (meilleure à moins bonne)":
            knn_results['Rating'] = pd.to_numeric(knn_results['Vote_average'], errors='coerce')
            knn_results = knn_results.sort_values(by='Rating', ascending=False)

        # Afficher les suggestions KNN
